<?php
/**
 * Class file for MywspackTypeGetTransactionData
 * @date 28/11/2012
 */
/**
 * Class MywspackTypeGetTransactionData
 * @date 28/11/2012
 */
class MywspackTypeGetTransactionData extends MywspackWsdlClass
{
	/**
	 * The customerID
	 * Meta informations :
	 ...
	 * @return MywspackTypeGetTransactionData
	 */
