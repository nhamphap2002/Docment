<?php
/**
 * Class file for MywspackTypeGetTransactionDataBetweenDates
 * @date 28/11/2012
 */
/**
 * Class MywspackTypeGetTransactionDataBetweenDates
 * @date 28/11/2012
 */
class MywspackTypeGetTransactionDataBetweenDates extends MywspackWsdlClass
{
	/**
	 * The customerID
	 * Meta informations :
	 ...
	 * @return MywspackTypeGetTransactionDataBetweenDates
	 */
